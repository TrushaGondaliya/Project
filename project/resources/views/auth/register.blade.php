                    ...
                    <div class="col-lg-3 form-group my-auto">
                        ...
                        <div class="container">
                            <form action="{{url('add-user')}}" method="post">
                                ...
                                <input type="password" name="confirm_password" placeholder="Re-write your Password"
                                    class="form-control"><br>
                            ...
                            <div class="text-center">
                                ...
                                <span class="pwd">Already Registered? </span><a class="reg"
                                    href="{{URL('login')}}">Login Here</a><br><br>
                            </div>
                            <footer>

...
<div class="container-fluid">
 ...
 <div class="container">
    ...
    <input type="password" name="new_password" placeholder="Enter your new password" class="form-control"><br>
    <label for="password">Confirm New Password</label><br>
    <input type="password" name="confirm_password" placeholder="Enter your confirm new password" class="form-control"><br>

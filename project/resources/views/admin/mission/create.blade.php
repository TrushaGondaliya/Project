                    ...
                    <td>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6 col-6">
                                ...
                                <select name="country" id="country-dropdown" class="cms-input" >
                        ...
                        <input type="text" name="organization_name" class="cms-input"
                            placeholder="Enter Mission organizarion name"><br><br>
                        ...
                        <div class="uploadOuter">
                            <div class="dragBox drag-nav">
                                ...
                                <input type="file" name="document[]" multiple onChange="dragNdrop(event)"

...
<div class="container">
    ...
    <div>
        ...
        <form action="{{url('admin/update-mission/'.$mission->mission_id)}}" method="POST"
            ...
            <table class="cms-table">
                ...
                <tbody>
                    <td>
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-6 col-6">
                                ...
                                <select name="country" id="country-dropdown" class="cms-input" id="">
                                    <option value="{{$mission->city->country_id}}">{{$mission->city->country->name}}
                                    </option>
                        ...
                        <input type="text" name="title" value="{{$mission->title}}" class="cms-input"
                            placeholder="Enter Mission Title"><br><br>

                        <span class="cms-label">Mission Description</span>
                        <div class="cms-textarea">
                            <textarea name="description" class="text-area" id="editor" cols=""
                                rows="">{{$mission->description}}</textarea>
                        </div><br>

                        <span class="cms-label">Mission Organization Name</span>
                        <input type="text" value="{{$mission->organization_name}}" name="organization_name"
                            class="cms-input" placeholder="Enter Mission organizarion name"><br><br>

                        <span class="cms-label">Mission Organization Detail</span>
                        <div class="cms-textarea">
                            <textarea name="organization_detail" class="text-area" id="editor" cols=""
                                rows="">{{$mission->organization_detail}}</textarea>
                        </div><br><br>

                        <span class="cms-label">Mission short Description</span>

                        <div class="cms-textarea">
                            <textarea name="short_description" class="text-area" id="" cols=""
                                rows="">{{$mission->short_description}}</textarea>
                        </div><br><br>
                        ...
                        <div id="otherField" class="only-select">
                            ...
                            @else
                            <input type="text" value="{{$goal->goal_objective_text}}" class="cms-input"
                        ...
                        <div id="timetext" class="only-select">
                            ...
                            <input type="date" name="start_date" class="cms-input"
                        ...
                        <div id="timetext" class="only-select">
                            <span class="cms-label">Start Date</span>
                            <input type="date" value="{{$mission->start_date}}" name="start_date" class="cms-input"
                                placeholder="Enter start Date"><br><br>
                            <span class="cms-label">End Date</span>
                            <input type="date" value="{{$mission->end_date}}" name="end_date" class="cms-input"
                       ...
                       <br>
                        ...
                        <input type="checkbox" name="skill_id[]" value="{{$item->skill_id}}"
                            {{in_array($item->skill_id,$missionskill)?'checked':''}}>{{$item->skill_name}}
                        @endforeach
                        </select>
                        <br><br>
                        ...
                        <div class="uploadOuter">
                            ...
                            <div class="dragBox drag-nav">
                                ...
                                <input type="file" name="image[]" onChange="dragNdrop(event)" ondragover="drag()"
                                    ondrop="drop()" id="uploadFile" multiple />
                            </div>
                        </div>
                        ...
                        <div class="uploadOuter">
                            <div class="dragBox drag-nav">
                                ...
                                <input type="file" name="document[]" onChange="dragNdrop(event)" ondragover="drag()"
                                    ondrop="drop()" id="uploadFile" multiple />
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            $.each(result.cities, function(key, value) {
                $("select[name='city']").append('<option value="' + value.city_id + '">' +
                    value.name + '</option>');
            });
        }
    });

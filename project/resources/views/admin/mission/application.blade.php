...
<main>
    ...
    <div class="container-fluid">
        <ul class="nav nav-tabs">
            <li class="nav-item"> <a class="nav-link nav" href="#">Application List</a> </li>
        </ul>
        <div class="container-fluid px-4">
            <div class="row pt-4">
                <div class="col-lg-3 form-outline mb-4 admin-search-div">
                    <form action="{{url('admin/application')}}" method="get">
                        <div class="admin-row">
                            <div>
                    ...
                    <table class="table user-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('admin/approve/'.$item->mission_application)}}"><span class=""><svg
            ...
            <div class="container mt-3">
                <ul class="pagination">
                    <li class="page-item">
                        <a class="page-link" href="{{url('admin/application?page='.$application->onFirstPage())}}"
                            aria-label="prevoius">
                    ...
                    @for($i=1;$i<=$application->lastpage();$i++)
                        @if($i==$application->currentPage())
                        <li class="page-item"><a class="page-link active"
                                href="{{url('admin/application?page='.$i)}}">{{$i}}</a> </li>
                        @else
                        ...
                        <li class="page-item">
                            <a class="page-link" href="{{url('admin/application?page='.$application->lastpage())}}"
                                aria-label="Next">

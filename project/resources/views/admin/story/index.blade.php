                                    ...
                                    <div>
                                        ...
                                        <a href="{{url('admin/published/'.$item->story_id)}}">
                                            <span class=""><svg xmlns="http://www.w3.org/2000/svg"
                                                    style="margin-left: 20px;" width="26" height="26" fill="#14c506"
                                        ...
                                        <a href="{{url('admin/decline-story/'.$item->story_id)}}">
                                            <span class="time">
                                                <svg xmlns="http://www.w3.org/2000/svg" style="margin-left: 20px;"
                                                    width="26" height="26" fill="#f88634" class="bi bi-x-circle"
                                                    viewBox="0 0 16 16">
                                                    <path
                                                        d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                                                    <path
                                        ...
                                        <button value="{{$item->story_id}}" class="deleteStorybtn delete-btn"><img
                                                style="width: 20px; height:25px;margin-left: 20px;"
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{url('admin/delete-story')}}" method="POST">
                @csrf

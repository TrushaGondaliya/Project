      ...
      <div class="col div-vol">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <td>4</td>
                    <td>49</td>
                    <td><a href=""><img style="width: 14px; height:17px" src="\images\bin.png"></a>   <span class="time"><img  style="width: 14px; height:17px" src="\images\edit.jpg"></span></td>
        ...
        <div class="for-call-popup">
            <form action="" class="call-popup">
                ...
                <div class="popup-btn">
                    ...
                    <input type="submit" class="edit-profile-button-1" value="Save" name="" id="">
                </div>
            </form>
        </div>

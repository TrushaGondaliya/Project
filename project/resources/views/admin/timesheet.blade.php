                ...
                <table class="table" id="myTable">
                    ...
                    <tbody class="data-row">
                        ...
                        <td style="display:   inline-flex;">
                            <button value="{{$time->timesheet_id}}" class="delete-btn deleteCategorybtn edit-btn"><img
                                    style="width: 14px; height:17px;" src="\images\bin.png">
                            </button>
                            <button value="{{$time->timesheet_id}}" class="time edit-btn" data-toggle="modal"
                                data-target="#edit-modal"><img style="width: 14px; height:17px;cursor:pointer"
            ...
            <div class="col div-vol">
                ...
                <table class="table" id="datatable">
                    ...
                    <tbody>
                        ...
                        <td>{{$goal->action}}</td>
                        <td><button value="{{$time->timesheet_id}}" class="delete-btn deleteCategorybtn edit-btn"><img
                                    style="width: 14px; height:17px;" src="\images\bin.png">
                            </button>
                            <button value="{{$goal->timesheet_id}}" class="timesheet_goal edit-btn"><img
                                    style="width: 14px; height:17px;cursor:pointer" src="\images\edit.jpg">
                            </button>
                            </a>
                        </td>
                    </tbody>
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content1">
            <form action="{{url('delete-time')}}" method="POST">
                @csrf

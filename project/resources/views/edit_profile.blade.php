                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        <form action="{{url('edit-profile')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="edit-profile-1">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div>
                                            <input type="text" name="first_name" value="{{Auth::user()->first_name}}"
                                                placeholder="Enter your name" class="edit-input" id="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div>
                                            <input type="text" name="last_name" value="{{Auth::user()->last_name}}"
                                                placeholder="Enter your surname" class="edit-input" id="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div>
                                            <input type="text" name="employee_id" value="{{Auth::user()->employee_id}}"
                                                placeholder="Enter your Employee ID" class="edit-input" id="">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div>
                                            <input type="text" name="title" value="{{Auth::user()->title}}"
                                                placeholder="Enter your Title" class="edit-input" id="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div>
                                            <input type="text" name="department" value="{{Auth::user()->department}}"
                                                placeholder="Enter your Department Name" class="edit-input" id="">
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <span class="story-input-text">My Profile*</span>
                                    <textarea type="text" name="profile_text" placeholder="Enter your Title"
                                        class="story-input-div" id="editor">{{Auth::user()->profile_text}}</textarea>
                                </div>
                                <div>
                                    <span class="story-input-text">Why I Volunteer?</span>
                                    <textarea type="text" name="why_i_volunteer" placeholder="Enter Your Comments..."
                                        class="story-input-div" id="">{{Auth::user()->why_i_volunteer}}</textarea>
                                </div>
                                ...
                                <br><br>
                                <ul class="nav nav-tabs-edit">
                                    <li class="nav-item"> <a class="nav-link nav-1" href="#">Address Information</a>
                                    </li>
                                </ul><br>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <ul class="nav nav-tabs-edit">
                                    <li class="nav-item"> <a class="nav-link nav-1" href="#">Personal Information</a>
                                    </li>
                                </ul><br>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div>
                                            <input type="text" value="{{Auth::user()->linked_in_url}}"
                                                name="linked_in_url" placeholder="Enter your linkedin URL"
                                                class="edit-input" id="">
                                        </div>
                                    </div>
                                </div>
